...
public class MantricoreParser extends Parser {
	...
	public static final int
		...
		BEGIN=18, END=19, ASSIGN=20, ADD=21, SUBTRACT=22, MULT=23, DIVIDE=24, 
		PRINT=25, READ=26, NUMBER=27, INT=28, FLOAT=29, FLOAT32=30, FLOAT64=31, 
		STRING=32, ID=33, NEWLINE=34, WS=35;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, "IF", "LOOP", "FUNCTION", "BEGIN", "END", "ASSIGN", 
			"ADD", "SUBTRACT", "MULT", "DIVIDE", "PRINT", "READ", "NUMBER", "INT", 
			"FLOAT", "FLOAT32", "FLOAT64", "STRING", "ID", "NEWLINE", "WS"
		};
	}
	...
	public final StartContext start() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 25870696448L) != 0)) {
				{
				{
				setState(32);
				_errHandler.sync(this);
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 25870565376L) != 0)) {
				{
				{
				setState(43);
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 8690696192L) != 0)) {
					{
					setState(42);
					program();
					}
